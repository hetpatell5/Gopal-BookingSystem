...
@section('content')
<div class="bg-white rounded-none shadow-sm p-8 max-w-4xl mx-auto">
    ...
    <form action="{{ route('passengers.update', $passenger->id) }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="seat_number" value="{{ old('seat_number', $passenger->seat_number) }}" class="w-full px-4 py-3 border border-gray-200 rounded-none focus:outline-none focus:ring-2 focus:ring-[#f0b44b] text-[14px]" required>
            </div>
            ...
            <div>
                ...
                <input type="text" name="village_name" value="{{ old('village_name', $passenger->village_name) }}" class="w-full px-4 py-3 border border-gray-200 rounded-none focus:outline-none focus:ring-2 focus:ring-[#f0b44b] text-[14px]">
            </div>
            ...
            <div>
                ...
                <input type="number" name="total_seats" value="{{ old('total_seats', $passenger->total_seats) }}" class="w-full px-4 py-3 border border-gray-200 rounded-none focus:outline-none focus:ring-2 focus:ring-[#f0b44b] text-[14px]">
            </div>
        ...
        <div class="mt-8 flex gap-4">
            <button type="submit" class="flex-1 bg-[#f0b44b] text-[#1c2238] font-bold py-3.5 rounded-none hover:bg-[#e0a43b] transition-colors shadow-sm">
                Save Changes
            </button>
