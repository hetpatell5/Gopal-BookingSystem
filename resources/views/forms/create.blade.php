    ...
    <div class="flex flex-col gap-4" style="flex:1 1 55%; min-width:0">
        ...
        <div class="flex gap-3">
            <button type="button" onclick="saveForm()"
                ...
                <i class="fa-solid fa-floppy-disk mr-2"></i> Create Form
            </button>
...
<form id="submitForm" method="POST" action="{{ route('forms.store') }}" style="display:none">
    @csrf
...
@include('forms._builder_script', ['initialFields' => []])
@endsection
